...
import com.gwh.camera.util.AngleUtil;
import com.gwh.camera.util.CameraParamUtil;
import com.gwh.camera.util.CheckPermission;
import com.gwh.camera.util.DeviceUtil;
...
//
        ...
        mCamera.takePicture(null, null, new Camera.PictureCallback() {
            ...
            public void onPictureTaken(byte[] data, Camera camera) {
                ...
                mCamera.startPreview();  //修复如果不调用 ，则画面不会更新
            }
        });
    }
